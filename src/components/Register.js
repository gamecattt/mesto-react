  ...
  return (
      <form onSubmit={handleSubmit} className="form">
        <div className="form__top">
          ...
          <input required name="email" value={formValue.email} onChange={handleChange} className="form__input" type="email" placeholder="Email"/>
            <span className="form__error-msg email-input-error"></span>
          <input required name="password" value={formValue.password} onChange={handleChange} className="form__input" type="password" placeholder="Пароль"/>
